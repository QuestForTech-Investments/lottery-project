...
const LogWinningNumbersBadge: FC<LogWinningNumbersBadgeProps> = memo(({ log }) => {
  ...
  if (log.singulaccion1) labels.push({ label: t('resultsAdmin.labels.singulaccion1'), value: log.singulaccion1 });
  if (log.singulaccion2) labels.push({ label: t('resultsAdmin.labels.singulaccion2'), value: log.singulaccion2 });
  if (log.singulaccion3) labels.push({ label: t('resultsAdmin.labels.singulaccion3'), value: log.singulaccion3 });
