 ...
 */
const TicketPrintTemplate: React.FC<TicketPrintTemplateProps> = ({ ticketData }) => {
  // Formatear fecha
  ...
  // Group lines por sorteo
  const groupLinesByDraw = (): DrawGroup[] => {
    const grouped: Record<string, DrawGroup> = {};
  ...
  return (
    <div className="ticket-thermal" id="ticket-print">
      ...
      <div className="prize-info">
        ...
        <div>Pale $1000 Pick3$600 Win4$5000</div>
...
export default memo(TicketPrintTemplate);
