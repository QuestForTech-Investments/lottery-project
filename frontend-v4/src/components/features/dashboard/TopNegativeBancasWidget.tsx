...
import { getTopNegativeBancas, type BancaBalanceItem } from '@/services/dashboardService';
import { formatCurrency } from '@/utils/formatCurrency';

const ACCENT = '#6366f1';
const DANGER = '#c62828';

const TopNegativeBancasWidget: React.FC = () => {
            ...
            <TableBody>
              {data.map(row => (
                <TableRow key={row.bettingPoolId} hover>
                  ...
                  <TableCell align="right" sx={{ fontSize: 12, color: DANGER, fontWeight: 600 }}>
...
export default TopNegativeBancasWidget;
