...
interface NumberControls {
  ...
  montoDirecto: number | string;
  enablePale: boolean;
  montoPale: number | string;
  enableSuperPale: boolean;
  montoSuperPale: number | string;
}

const AutomaticLimits = (): React.ReactElement => {
  const [activeTab, setActiveTab] = useState<number>(0);

  const [generalNumberControls, setGeneralNumberControls] = useState<NumberControls>({
    enableDirecto: false,
    montoDirecto: 0,
    enablePale: false,
    montoPale: 0,
  ...
  const [lineControls, setLineControls] = useState<NumberControls>({
    enableDirecto: false,
    montoDirecto: 0,
    enablePale: false,
    montoPale: 0,
  ...
  const [palesToBlock, setPalesToBlock] = useState<string>('');
  ...
  const handleUpdateBlocking = useCallback((): void => {
