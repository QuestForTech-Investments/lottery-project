      ...
      >
        ...
        >
          <button
            ...
            onMouseEnter={(e) => e.target.style.backgroundColor = 'rgb(82, 77, 71)'}
            onMouseLeave={(e) => e.target.style.backgroundColor = 'rgb(102, 97, 91)'}
          >
            Cancel
          </button>
          <button
            ...
            onMouseEnter={(e) => e.target.style.backgroundColor = 'rgb(61, 183, 186)'}
            onMouseLeave={(e) => e.target.style.backgroundColor = 'rgb(81, 203, 206)'}
          >
            OK
          </button>
        </div>
