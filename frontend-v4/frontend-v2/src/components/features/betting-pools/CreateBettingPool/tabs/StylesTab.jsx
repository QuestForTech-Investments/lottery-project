 ...
 */
const StylesTab = ({ formData, handleChange }) => {
  return (
    <Box sx={{ p: 3 }}>
        ...
        <Grid item xs={12}>
          <Paper variant="outlined" sx={{ p: 2, bgcolor: 'info.lighter' }}>
            <Typography variant="body2" color="info.dark">
              ...
              Puedes modificar estos ajustes en cualquier momento desde la configuración de la banca.
            </Typography>
          </Paper>
        </Grid>
      </Grid>
...
const arePropsEqual = (prevProps, nextProps) => {
  ...
  const styleFields = ['sellScreenStyles', 'ticketPrintStyles'];
