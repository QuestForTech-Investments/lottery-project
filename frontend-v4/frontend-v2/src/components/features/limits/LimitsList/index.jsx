...
const LimitsList = () => {
  ...
  const [activeWeekDay, setActiveWeekDay] = useState(0); // 0 = Lunes
  const [activeLimitType, setActiveLimitType] = useState(0);
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(3, 1fr)' }, gap: 2, mb: 3 }}>
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                onChange={(e) => setSelectedLimitTypes(e.target.value)}
            ...
            <FormControl fullWidth>
              ...
              <Select
                multiple
                value={selectedDraws}
                onChange={(e) => setSelectedDraws(e.target.value)}
