...
const CreateTransactionModal = ({ open, onClose }) => {
  ...
  const [sourceInitialBalance] = useState('0.00');
  const [sourceFinalBalance] = useState('0.00');
  const [destInitialBalance] = useState('0.00');
  const [destFinalBalance] = useState('0.00');
              ...
              {transactions.length === 0 ? (
                ...
                transactions.map((transaction, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell sx={{ fontSize: '13px' }}>${parseFloat(transaction.debit || 0).toFixed(2)}</TableCell>
                    <TableCell sx={{ fontSize: '13px' }}>${parseFloat(transaction.credit || 0).toFixed(2)}</TableCell>
                    <TableCell sx={{ fontSize: '13px' }}>${parseFloat(transaction.initialBalance || 0).toFixed(2)}</TableCell>
                    <TableCell sx={{ fontSize: '13px' }}>${parseFloat(transaction.finalBalance || 0).toFixed(2)}</TableCell>
