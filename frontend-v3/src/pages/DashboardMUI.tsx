      ...
      <Box sx={{ maxWidth: '1400px', mx: 'auto' }}>
            ...
            <Paper elevation={3} sx={{ p: 3 }}>
              ...
              <FormControl fullWidth size="small" sx={{ mb: 2 }}>
                ...
                <Select
                  ...
                  onChange={(e) => handleSortitionChange(e as React.ChangeEvent<HTMLSelectElement>)}
                  label="Sorteo"
                >
                  {sortitions.map((sortition) => (
                    <MenuItem key={sortition} value={sortition}>
                      {sortition}
                    </MenuItem>
                  ))}
                </Select>
                ...
                <Table size="small">
                  <TableHead>
                    <TableRow sx={{ bgcolor: 'grey.100' }}>
                      ...
                      <TableCell sx={{ fontWeight: 'bold', fontSize: '0.75rem', p: 1 }}>Jugada</TableCell>
                      <TableCell sx={{ fontWeight: 'bold', fontSize: '0.75rem', p: 1 }}>Monto</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {jugadas.length === 0 ? (
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                <FormControl fullWidth size="small">
                  ...
                  <Select
                    ...
                    onChange={(e: SelectChangeEvent) => setSelectedQuickPublish(e.target.value)}
                    label="Sorteo"
                  >
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  <FormControl fullWidth size="small">
                    ...
                    <Select
                      ...
                      onChange={(e: SelectChangeEvent) => setSelectedBloqueoSortition(e.target.value)}
                      label="Sorteo"
                    >
                      <MenuItem value="">Seleccione</MenuItem>
                  ...
                  <FormControl fullWidth size="small">
                    ...
                    <Select
                      ...
                      onChange={(e: SelectChangeEvent) => setSelectedPlayType(e.target.value)}
        ...
        <Paper elevation={3} sx={{ p: 2, mb: 3 }}>
          <Typography variant="body1" align="center" sx={{ fontWeight: 500 }}>
            Bancas vendiendo: Martes:{' '}
            <Box component="span" sx={{ color: '#4dd4d4', fontWeight: 'bold' }}>
              {bancasVendiendo.martes}
            </Box>
            , Miércoles:{' '}
            <Box component="span" sx={{ color: '#4dd4d4', fontWeight: 'bold' }}>
              {bancasVendiendo.miercoles}
            </Box>
            , hoy:{' '}
            <Box component="span" sx={{ color: '#4dd4d4', fontWeight: 'bold' }}>
              {bancasVendiendo.hoy}
