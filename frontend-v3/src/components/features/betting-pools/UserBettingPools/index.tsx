/**
 * UserBettingPools Component
 * Modern Material-UI version showing users with their assigned betting pools
...
/**
 * UserBettingPoolsMUI Component
 * Shows users with their assigned betting pools
 * Allows filtering by zone, search, and password changes
 */
const UserBettingPoolsMUI: React.FC = () => {
  const {
    users,
    totalUsers,
    zones,
...
/**
 * Memoize UserBettingPoolsMUI to prevent unnecessary re-renders
 * Component only re-renders when data or filters change
 */
export default React.memo(UserBettingPoolsMUI);
