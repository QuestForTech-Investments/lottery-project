 ...
 * Contains ALL configuration fields with Material-UI styling
...
const ConfigurationTab: React.FC<ConfigurationTabProps> = ({ formData, handleChange }) => {
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <FormControlLabel
            control={<Switch checked={formData.smsOnly} onChange={handleChange} name="smsOnly" />}
            label="Sólo SMS"
          />
        </Grid>
 ...
 */
const arePropsEqual = (prevProps: ConfigurationTabProps, nextProps: ConfigurationTabProps) => {
  ...
  const configFields: (keyof BettingPoolFormData)[] = [
    'fallType',
    'deactivationBalance',
    'dailySaleLimit',
    'dailyBalanceLimit',
    'enableTemporaryBalance',
    'temporaryAdditionalBalance',
    'isActive',
    'controlWinningTickets',
    'allowJackpot',
    'printEnabled',
    'printTicketCopy',
    'smsOnly',
