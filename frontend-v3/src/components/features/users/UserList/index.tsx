...
const UserListMUI: React.FC = () => {
  ...
  const [selectedUser, setSelectedUser] = useState<{ userId: number | null; username: string }>({
    userId: null,
    username: ''
  });
   ...
   * useCallback: Prevents recreation on every render
   */
  const createSortHandler = useCallback((property: keyof User) => () => {
                      ...
                      >
                        {column.sortable ? (
                          <TableSortLabel
                            ...
                            onClick={createSortHandler(column.id as keyof User)}
                          >
                            {column.label}
                          </TableSortLabel>
                        ) : (
