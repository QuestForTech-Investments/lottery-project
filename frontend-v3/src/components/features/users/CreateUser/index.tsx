...
// NOTE: These common components need to be ported to v3 or replaced with alternatives
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Box>
                  ...
                  {/* TODO: Port ReactMultiselect from v2 or replace with MUI Autocomplete */}
                  <Alert severity="info" sx={{ mb: 2 }}>
                    ReactMultiselect component needs to be ported from v2
                  </Alert>
                  {errors.zones && (
              ...
              {formData.assignBanca && formData.zoneIds.length > 0 && (
                <Grid item xs={12}>
                  <Box>
                    ...
                    {/* TODO: Port BettingPoolSelector from v2 */}
                    <Alert severity="info" sx={{ mb: 2 }}>
                      BettingPoolSelector component needs to be ported from v2
                    </Alert>
                    {errors.bettingPool && (
                      <Typography variant="caption" color="error" sx={{ mt: 1, display: 'block' }}>
                        {errors.bettingPool}
