-- ============================================
-- CONFIGURACIÓN COMPLETA DE TODOS LOS TIPOS DE APUESTA USA
-- Primero eliminamos TODOS los prize_types de USA (bet_type_id 4-21)
-- ============================================

PRINT 'Limpiando configuración existente de USA...';
PRINT '';

-- Eliminar TODOS los prize_types de USA (bet_type_id 4-21)
DELETE FROM prize_types WHERE bet_type_id >= 4;

PRINT 'Configurando tipos de apuesta USA...';
PRINT '';

-- ============================================
-- CASH3 STRAIGHT (bet_type_id = 4)
-- ============================================
...
-- ============================================
-- CASH3 FRONT STRAIGHT (bet_type_id = 6)
-- ============================================
INSERT INTO prize_types (bet_type_id, field_code, field_name, default_multiplier, display_order)
VALUES
...
-- ============================================
-- CASH3 BACK STRAIGHT (bet_type_id = 8)
-- ============================================
INSERT INTO prize_types (bet_type_id, field_code, field_name, default_multiplier, display_order)
VALUES
...
-- ============================================
-- PANAMA (bet_type_id = 21)
-- No tiene sub-campos en la configuración proporcionada
-- ============================================

PRINT '';
PRINT 'Configuración USA completada exitosamente!';
PRINT '';
PRINT 'Resumen de prize_types USA insertados:';
