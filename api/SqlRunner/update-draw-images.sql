...
-- Storage Account: lotterysorteoicons
-- Container: sorteos (public blob access)
-- Resource Group: rg-lottery-api
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/anguila.png' WHERE draw_name LIKE '%Anguila%';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/texas.png' WHERE draw_name LIKE '%TEXAS%';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/real.png' WHERE draw_name = 'REAL';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/gana-mas.png' WHERE draw_name = 'GANA MAS';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/la-primera.png' WHERE draw_name LIKE '%LA PRIMERA%';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/la-suerte.png' WHERE draw_name LIKE '%LA SUERTE%';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/lotedom.png' WHERE draw_name = 'LOTEDOM';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/king-lottery.png' WHERE draw_name LIKE '%King Lottery%';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/new-york.png' WHERE draw_name LIKE '%NEW YORK%' OR draw_name LIKE '%NY %';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/florida.png' WHERE draw_name LIKE '%FLORIDA%' OR draw_name LIKE '%FL %';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/loteka.png' WHERE draw_name = 'LOTEKA';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/nacional.png' WHERE draw_name = 'NACIONAL';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/diaria.png' WHERE draw_name LIKE '%DIARIA%';
UPDATE draws SET image_url = 'https://lotterysorteoicons.blob.core.windows.net/sorteos/quiniela.png' WHERE draw_name LIKE '%QUINIELA%';
