...
const DrawsList = () => {
  ...
  const [draws, setDraws] = useState([
    ...
    { id: 65, index: 65, name: 'Directo NY', abbreviation: 'DR NY', color: '#FF77 33' },
        ...
        <div style={{ overflowX: 'auto' }}>
          <table className="table table-hover" style={{ fontSize: '14px' }}>
            <thead style={{ backgroundColor: '#f5f5f5' }}>
              <tr>
                <th style={{ fontSize: '12px', color: '#787878', fontWeight: 600, width: '50px' }}>Index</th>
                <th
                ...
                >
                  Abreviación {sortBy === 'abbreviation' && (sortOrder === 'asc' ? '▲' : '▼')}
                </th>
                <th style={{ fontSize: '12px', color: '#787878', fontWeight: 600, width: '100px' }}>Color</th>
                <th style={{ fontSize: '12px', color: '#787878', fontWeight: 600, textAlign: 'center', width: '100px' }}>Acciones</th>
              </tr>
            </thead>
            <tbody>
              {sortedDraws.length > 0 ? (
                sortedDraws.map((draw, idx) => (
                  ...
                  >
                    <td>
                      <i className="fa fa-bars" style={{ color: '#999', marginRight: '8px' }}></i>
                      {draw.index}
                    </td>
                    <td>{draw.name}</td>
                    <td>{draw.abbreviation}</td>
                    <td>
                      <input
                        type="color"
                        value={draw.color}
