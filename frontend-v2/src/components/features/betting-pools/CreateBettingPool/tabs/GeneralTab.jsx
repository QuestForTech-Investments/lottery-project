 ...
 */
const GeneralTab = ({ formData, errors, zones, loadingZones, handleChange }) => {
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <TextField
            ...
            helperText={errors.branchCode || 'Generado automáticamente'}
          />
        </Grid>
...
const arePropsEqual = (prevProps, nextProps) => {
  ...
  const generalFields = ['bettingPoolName', 'branchCode', 'zoneId', 'location', 'reference', 'username', 'password', 'confirmPassword', 'comment'];
