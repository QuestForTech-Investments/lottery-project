            ...
            <Table size="small">
              <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
                <TableRow>
                  <TableCell>
                    <TableSortLabel
                      active={sortConfig.key === 'concepto'}
              ...
              <TableBody>
                {filteredAndSortedData.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={showNotes ? 13 : 12} align="center" sx={{ py: 3 }}>
                  ...
                  <>
                    {filteredAndSortedData.map((item) => (
                      <TableRow key={item.id} hover>
                        ...
                        <TableCell align="right" sx={{ color: '#dc3545', fontWeight: 500 }}>
                          ${item.debito.toFixed(2)}
                        </TableCell>
                        <TableCell align="right" sx={{ color: '#28a745', fontWeight: 500 }}>
                    ...
                    <TableRow sx={{ backgroundColor: '#f8f9fa', fontWeight: 600 }}>
                      <TableCell colSpan={showNotes ? 9 : 8} align="right">
                      ...
                      <TableCell align="right" sx={{ color: '#28a745', fontWeight: 600 }}>
