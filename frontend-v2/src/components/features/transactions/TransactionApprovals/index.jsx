            ...
            <Table size="small">
              <TableHead sx={{ bgcolor: '#f8f9fa' }}>
                <TableRow>
                  <TableCell>
                    <TableSortLabel
                      active={sortConfig.key === 'cobrador'}
                      direction={sortConfig.key === 'cobrador' ? sortConfig.direction : 'asc'}
                  ...
                  <TableCell>
                    <TableSortLabel
                      active={sortConfig.key === 'revisadoPor'}
                      direction={sortConfig.key === 'revisadoPor' ? sortConfig.direction : 'asc'}
                  ...
                  <TableCell>
                    <TableSortLabel
                      active={sortConfig.key === 'banca'}
                      direction={sortConfig.key === 'banca' ? sortConfig.direction : 'asc'}
                  ...
                  <TableCell>
                    <TableSortLabel
                      active={sortConfig.key === 'zonaPrimaria'}
                      direction={sortConfig.key === 'zonaPrimaria' ? sortConfig.direction : 'asc'}
                  ...
                  <TableCell>
                    <TableSortLabel
                      active={sortConfig.key === 'banco'}
                      direction={sortConfig.key === 'banco' ? sortConfig.direction : 'asc'}
                  ...
                  <TableCell align="right">
                    <TableSortLabel
                      active={sortConfig.key === 'credito'}
                      direction={sortConfig.key === 'credito' ? sortConfig.direction : 'asc'}
                  ...
                  <TableCell align="right">
                    <TableSortLabel
                      active={sortConfig.key === 'debito'}
                      direction={sortConfig.key === 'debito' ? sortConfig.direction : 'asc'}
                  ...
                  <TableCell align="center" sx={{ fontWeight: 600, width: '140px' }}>
                    Actions
                  </TableCell>
                </TableRow>
              </TableHead>
                  ...
                  filteredAndSortedData.map((item) => (
                    <TableRow key={item.id} hover>
                      ...
                      <TableCell>
                        <Chip
                          label={item.tipo}
                          color={item.tipo === 'COBRO' ? 'info' : 'warning'}
                          size="small"
                          sx={{ fontSize: '12px' }}
                        />
                      </TableCell>
                      ...
                      <TableCell align="center">
                        {item.estado === 'PENDIENTE' ? (
                          ...
                          <Chip
                            label={item.estado}
                            color={getEstadoChip(item.estado)}
                            size="small"
                            sx={{ fontSize: '11px' }}
                          />
                        )}
