 ...
 * @param {number} userId - User ID
 * @returns {Promise} - User permissions wrapped in success response
 */
 ...
 * @param {number} bettingPoolId - Branch ID
 * @returns {Promise} - Users list
 */
export const getUsersByBranch = async (bettingPoolId) => {
  return api.get(`/users/by-bettingPool/${bettingPoolId}`)
}
 ...
 * @param {number} userData.bettingPoolId - Branch ID (optional)
...
/**
 * Update user completely (permissions, zone, bettingPool, role)
 * @param {number} userId - User ID
 ...
 * @returns {Promise} - Result
 */
export const adminResetPassword = async (userId, passwordData) => {
